	...
	switch (topic) {
		...
		case 'c':
			embed.setTitle('**Character Help**')
					...
					.addField(`${prefix}char damage/fatigue/fwound/w characterName +X/-X`, 'Increases/decreases wounds for characterName by x.')
					...
					.addField(`${prefix}char curriculum_xp characterName +X/-X`, 'Increases/decreases curriculum_xp for characterName by x.')
